<div class="w-3/5 mx-auto py-8 flex justify-between flex-wrap">
    <div class="w-48 bg-white rounded-lg shadow-md p-6 cursor-pointer mb-8 hover:bg-green-100 focus:outline-white">
        <div class="flex justify-between items-center mb-3">
            <h1 class="uppercase text-base tracking-wide text-indigo-900 my-2">Growth</h1>
            <div>
        ...
        <div class="mb-1 font-semibold text-blue-darker">
            <span class="text-5xl mr-2">1</span>
            <span class="text-2xl">GB</span>
        </div>
        <div>
            <span class="text-xl text-blue-alternate">$</span>
            <span class="text-xl font-semibold text-blue-darker">5</span>
    ...
    <div class="w-48 bg-white rounded-lg shadow-md p-6 cursor-pointer mb-8 hover:bg-green-100 focus:outline-white">
        <div class="flex justify-between items-center mb-3">
            <h1 class="uppercase text-base tracking-wide text-indigo-900 my-2">Hobby</h1>
            <div>
                <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="checkmark-outline" fill-rule="nonzero">
        ...
        <div class="mb-1 font-semibold text-blue-darker">
            <span class="text-5xl mr-2">5</span>
            <span class="text-2xl">GB</span>
        </div>
        <div>
            <span class="text-xl text-blue-alternate">$</span>
            <span class="text-xl font-semibold text-blue-darker">10</span>
            <span class="text-blue-alternate mx-1">/</span>
            <span class="text-lg text-blue-alternate">mo</span>
          </div>
    </div>
    ...
    <div class="w-48 bg-white rounded-lg shadow-md p-6 cursor-pointer mb-8 hover:bg-green-100 focus:outline-white">
        <div class="flex justify-between items-center mb-3">
            <h1 class="uppercase text-base tracking-wide text-indigo-900 my-2">Business</h1>
            <div>
                <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="checkmark-outline" fill-rule="nonzero">
        ...
        <div class="mb-1 font-semibold text-blue-darker">
            <span class="text-5xl mr-2">10</span>
            <span class="text-2xl">GB</span>
        </div>
        <div>
            <span class="text-xl text-blue-alternate">$</span>
            <span class="text-xl font-semibold text-blue-darker">15</span>
            <span class="text-blue-alternate mx-1">/</span>
            <span class="text-lg text-blue-alternate">mo</span>
          </div>
    </div>
    ...
    <div class="w-48 bg-white rounded-lg shadow-md p-6 cursor-pointer mb-8 hover:bg-green-100 focus:outline-white">
        <div class="flex justify-between items-center mb-3">
            <h1 class="uppercase text-base tracking-wide text-indigo-900 my-2">Enterprise</h1>
            <div>
                <svg class="w-6 h-6" width="200px" height="200px" viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="checkmark-outline" fill-rule="nonzero">
        ...
        <div class="mb-1 font-semibold text-blue-darker">
            <span class="text-5xl mr-2">20</span>
            <span class="text-2xl">GB</span>
        </div>
        <div>
            <span class="text-xl text-blue-alternate">$</span>
            <span class="text-xl font-semibold text-blue-darker">20</span>
            <span class="text-blue-alternate mx-1">/</span>
            <span class="text-lg text-blue-alternate">mo</span>
          </div>
    </div>
